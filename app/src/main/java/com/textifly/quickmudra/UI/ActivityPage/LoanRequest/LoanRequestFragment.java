...
public class LoanRequestFragment extends Fragment {
    ...
    private void setLayout() {
        binding.rvRequestLoan.setLayoutManager(new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false));
    }

    private void loadLoan() {
        modelList = new ArrayList<>();
        //CustomProgressDialog.showDialog(getActivity(),true);
        StringRequest sr = new StringRequest(Request.Method.POST, Urls.PENDING_REQUEST, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equals("0")) {
                        binding.rvRequestLoan.setVisibility(View.VISIBLE);
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String paid_status = object.getString("loan_status");
                        ...
                        binding.rvRequestLoan.setAdapter(adapter);
                    }else{
                        binding.rvRequestLoan.setVisibility(View.GONE);
