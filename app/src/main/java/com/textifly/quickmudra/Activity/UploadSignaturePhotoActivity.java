...
public class UploadSignaturePhotoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        CustomProgressDialog.showDialog(UploadSignaturePhotoActivity.this,true);
        StringRequest sr = new StringRequest(Request.Method.POST, Urls.UPLOADED_DOCUMENT_FETCH, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                CustomProgressDialog.showDialog(UploadSignaturePhotoActivity.this,false);
                try {
                    ...
                    if(jsonObject.getString("status").equals("0")){
                        ...
                        for(int i =0;i<jsonArray.length();i++){
                            ...
                            if(object.getString("file_type").equalsIgnoreCase("signature")){
                                Glide.with(binding.getRoot()).load(Urls.IMAGE_URL+object.getString("image1")).into(binding.ivSignature);
                            }
                        }
                    }
        ...
        Volley.newRequestQueue(UploadSignaturePhotoActivity.this).add(sr);
    }

    private void BtnClick() {
        binding.tvContinue.setOnClickListener(this);
        binding.ivSignature.setOnClickListener(this);
        ...
        switch (view.getId()){
            case R.id.ivSignature:
                if (checkAndRequestPermissions(this)) {
                    chooseImage(UploadSignaturePhotoActivity.this);
                }
                break;
            case R.id.tvNext:
            ...
            case R.id.tvContinue:
                ...
                if (SelfSignatureFile != null) {
                    CustomProgressDialog.showDialog(UploadSignaturePhotoActivity.this, true);
                    uploadVoterId();
                } else {
                    Toast.makeText(UploadSignaturePhotoActivity.this, "Please add Self Signature", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
    ...
    private boolean checkAndRequestPermissions(Context context) {
        ...
        if (!listPermissionsNeeded.isEmpty()) {
            ActivityCompat.requestPermissions(UploadSignaturePhotoActivity.this, listPermissionsNeeded
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        switch (requestCode) {
            case REQUEST_ID_MULTIPLE_PERMISSIONS:
                if (ContextCompat.checkSelfPermission(UploadSignaturePhotoActivity.this,
                        Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(UploadSignaturePhotoActivity.this.getApplicationContext(),
                            "FlagUp Requires Access to Camara.", Toast.LENGTH_SHORT)
                            .show();
                } else if (ContextCompat.checkSelfPermission(UploadSignaturePhotoActivity.this,
        ...
        if (resultCode != RESULT_CANCELED) {
            switch (requestCode) {
                case 0://Camera
                    ...
                    binding.ivSignature.setImageBitmap(photo);
                    // CALL THIS METHOD TO GET THE URI FROM THE BITMAP
                    Uri tempUri = getImageUri(this, photo);
                    // CALL THIS METHOD TO GET THE ACTUAL PATH
                    //File finalFile = new File(getRealPathFromURI(tempUri));
                    SelfSignatureFile = new File(getRealPathFromURI(tempUri));
                    Log.e("finalFile==", String.valueOf(SelfSignatureFile));
                ...
                case 1:
                    ...
                    if (null != selectedImageUri) {
                        ...
                        SelfSignatureFile = new File(path);
                            /*listFile = new ArrayList<>();
        ...
        call.enqueue(new Callback<ResponseDataModel>() {
            ...
            public void onResponse(Call<ResponseDataModel> call, Response<ResponseDataModel> response) {
                ...
                if (model.getStatus().equals("0")) {
                    Toast.makeText(UploadSignaturePhotoActivity.this, "Saved Successfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(UploadSignaturePhotoActivity.this, SelfieActivity.class));
                    overridePendingTransition(R.anim.fade_in_animation,R.anim.fade_out_animation);
                }
            }
