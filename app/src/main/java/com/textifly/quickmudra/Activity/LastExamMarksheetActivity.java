...
public class LastExamMarksheetActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private boolean checkAndRequestPermissions(Context context) {
        ...
        if (!listPermissionsNeeded.isEmpty()) {
            ActivityCompat.requestPermissions(LastExamMarksheetActivity.this, listPermissionsNeeded
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        switch (requestCode) {
            case REQUEST_ID_MULTIPLE_PERMISSIONS:
                if (ContextCompat.checkSelfPermission(LastExamMarksheetActivity.this,
                        Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(LastExamMarksheetActivity.this.getApplicationContext(),
                            "FlagUp Requires Access to Camara.", Toast.LENGTH_SHORT)
                            .show();
                } else if (ContextCompat.checkSelfPermission(LastExamMarksheetActivity.this,
        ...
        if (resultCode != RESULT_CANCELED) {
            switch (requestCode) {
                case 0://Camera
                    ...
                    binding.marksheet.setImageBitmap(photo);
                    // CALL THIS METHOD TO GET THE URI FROM THE BITMAP
                    Uri tempUri = getImageUri(this, photo);
                    // CALL THIS METHOD TO GET THE ACTUAL PATH
                    //File finalFile = new File(getRealPathFromURI(tempUri));
                    LastMarksheetFile = new File(getRealPathFromURI(tempUri));
                    Log.e("finalFile==", String.valueOf(LastMarksheetFile));
                ...
                case 1:
                    ...
                    if (null != selectedImageUri) {
                        ...
                        binding.marksheet.setImageBitmap(bitmap);
                        //File finalFile2 = new File(path);
                        LastMarksheetFile = new File(path);
                            /*listFile = new ArrayList<>();
        ...
        call.enqueue(new Callback<ResponseDataModel>() {
            ...
            public void onResponse(Call<ResponseDataModel> call, Response<ResponseDataModel> response) {
                ...
                if (model.getStatus().equals("0")) {
                    Toast.makeText(LastExamMarksheetActivity.this, "Saved Successfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(LastExamMarksheetActivity.this,UploadCollegeIdActivity.class));
                    overridePendingTransition(R.anim.fade_in_animation,R.anim.fade_out_animation);
                }
            }
